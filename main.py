...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        # frame = cv2.flip(frame, 1) flip frame (disco party)
        cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 0, 0), 4)
        cv2.circle(frame, (x1, y1), radius=4, color=(255, 255, 255), thickness=-1)
        cv2.circle(frame, (x2, y2), radius=4, color=(0, 0, 0), thickness = -1)
